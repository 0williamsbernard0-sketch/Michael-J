...
const PROGRAMS = [
  { icon: "🎭", title: "Building a Character", desc: "A 6-part breakdown of MBJ's process, from script to screen.", level: "All Levels" },
  { icon: "🎬", title: "On-Camera Technique", desc: "Practical exercises for screen presence and timing.", level: "Intermediate" },
  { icon: "🗣️", title: "Voice & Delivery", desc: "Vocal control, dialects, and command of a scene.", level: "Intermediate" },
  { icon: "🌟", title: "From Audition to Set", desc: "What actually happens between casting and your first day filming.", level: "All Levels" },
];
    ...
    <div className="min-h-screen bg-[#12151A] text-[#F1ECDF] font-body">
      ...
      <main className="pt-28 pb-20 px-5 sm:px-10 max-w-5xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {PROGRAMS.map((p) => (
            <LockGate key={p.title} minHeight="min-h-[160px]">
